...
wget -O delete "http://vira.cf/hapus.sh"
wget -O check "http://vira.cf/user-login.sh"
...
# info
clear
echo "Autoscript Include:" |     log-install.txt
...
echo "member (Check SSH Member)"  | tee -a log-install.txt
